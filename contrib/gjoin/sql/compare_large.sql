...
INSERT INTO t1 SELECT mod(i, 100000), 100000 * random() FROM generate_series(1,1000000) s(i);
INSERT INTO t2 SELECT mod(i, 100000), 100000 * random() FROM generate_series(1,1000000) s(i);
...
INSERT INTO t1 SELECT mod(i, 100000), 100000 * random() FROM generate_series(1,1000000) s(i) ORDER BY random();
INSERT INTO t2 SELECT mod(i, 100000), 100000 * random() FROM generate_series(1,1000000) s(i) ORDER BY random();
