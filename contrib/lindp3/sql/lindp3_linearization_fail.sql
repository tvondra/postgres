...
-- Force LinDP++ on for this small problem and use a single linearization so
-- the failure is deterministic and independent of the adaptive seed count.
SET lindp3.enabled = on;
SET lindp3.min_threshold = 3;
