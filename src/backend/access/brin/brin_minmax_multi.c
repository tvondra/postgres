...
/*
 * Returns true if the first range (a1,a2) is shorter than (b1,b2).
 */
Datum
 ...
 * Returns true if the first range (a1,a2) is shorter than (b1,b2).
 *
 * XXX We do approximate the deltas (which would have to be 128-bit)
 * with a 64-bit floating point value. The small inaccuracies should not
 * matter in practice, in the worst case we'll decide to merge ranges
 * that are not the closest ones.
 */
Datum
