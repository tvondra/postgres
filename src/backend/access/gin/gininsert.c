 ...
 * number).
 *
 * We try freezing TIDs at the beginning of the list first. We do it here,
 * before actually adding the new data to the buffer, because it may allow
 * us to trim the existing list earlier. In any case it means the frozen
 * data will be excluded from the mergesort.
 */
static bool
