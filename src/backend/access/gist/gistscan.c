...
gistbeginscan(Relation r, int nkeys, int norderbys)
{
	...
	/*
	 * Use second opaque area for our per-item GISTBatchItem array
	 *
	 * XXX Most scans only need to store a recheck flag.  We could save memory
	 * in that common case by just asking for an array of booleans here.
	 */
