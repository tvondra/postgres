 ...
 *
 * FIXME probably needs to check the object type added from the schema
 */
bool
 ...
 *
 * This should only be used FOR TABLES IN SCHEMA and FOR SEQUENCES IN SCHEMA publications.
 *
...
/*
 * Gets the list of all relations published by FOR TABLES IN SCHEMA of
