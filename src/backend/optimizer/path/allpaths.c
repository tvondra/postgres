					 ...
					 List *initial_rels)
{
	...
	{
		double		budget = (double) join_search_effort_limit;
		double		effort;
...
make_rel_from_joinlist(PlannerInfo *root, List *joinlist)
{
	...
	else
	{
		...
		else if (enable_geqo && join_search_too_hard(root, levels_needed,
													 initial_rels))
