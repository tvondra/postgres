...
static void WalSndXLogRead(char *buf, XLogRecPtr startptr, Size count);
					   ...
					   XLogRecPtr targetRecPtr, char *cur_page, TimeLineID *pageTLI)
{
	...
	WalSndXLogRead(cur_page, targetPagePtr, XLOG_BLCKSZ);
 ...
 */
static void
WalSndXLogRead(char *buf, XLogRecPtr startptr, Size count)
{
	char	   *p;
	XLogRecPtr	recptr;
	Size		nbytes;
...
XLogSendPhysical(void)
{
	...
	WalSndXLogRead(&output_message.data[output_message.len], startptr, nbytes);
