...
ProcGlobalShmemSize(void)
{
	...
	size = add_size(size, PGFastPathLockShmemSize());
...
InitProcGlobal(void)
{
	...
	requestSize = PGFastPathLockShmemSize();

	fpPtr = ShmemInitStruct("Fast-Path Locks",
							PGFastPathLockShmemSize(),
							&found);
