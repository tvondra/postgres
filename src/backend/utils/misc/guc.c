...
static struct config_bool ConfigureNamesBool[] =
{
	...
	{
		{"devel_standard_join_search", PGC_USERSET, DEVELOPER_OPTIONS,
			NULL,
			NULL,
			GUC_EXPLAIN
		},
	...
	{
		{"devel_set_rel_pathlist", PGC_USERSET, DEVELOPER_OPTIONS,
			NULL,
			NULL,
			GUC_EXPLAIN
		},
	...
	{
		{"devel_add_paths_to_grouping_rel", PGC_USERSET, DEVELOPER_OPTIONS,
			NULL,
			NULL,
			GUC_EXPLAIN
		},
	...
	{
		{"devel_create_partial_grouping_paths", PGC_USERSET, DEVELOPER_OPTIONS,
			NULL,
			NULL,
			GUC_EXPLAIN
		},
	...
	{
		{"devel_create_partial_grouping_paths_2", PGC_USERSET, DEVELOPER_OPTIONS,
			NULL,
			NULL,
			GUC_EXPLAIN
		},
