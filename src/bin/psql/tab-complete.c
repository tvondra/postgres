...
/* CREATE PUBLICATION */
	...
	else if (Matches("CREATE", "PUBLICATION", MatchAny, "FOR", "SEQUENCES"))
		COMPLETE_WITH("IN SCHEMA");
	else if (Matches("CREATE", "PUBLICATION", MatchAny, "FOR", "TABLE", MatchAny) && !ends_with(prev_wd, ','))
		COMPLETE_WITH("WHERE (", "WITH (");
	else if (Matches("CREATE", "PUBLICATION", MatchAny, "FOR", "SEQUENCE", MatchAny) && !ends_with(prev_wd, ','))
		COMPLETE_WITH("WHERE (", "WITH (");
	...
	/*
	 * Complete "CREATE PUBLICATION <name> FOR TABLES|SEQUENCES IN SCHEMA <schema>, ..."
	 */
