...
/* bloom bytea */
DATA(insert (	5021	 17   17 3 s	  1955	  3580 0 ));
/* minmax "char" */
...
/* bloom "char" */
DATA(insert (	5022	 18   18 3 s		92	  3580 0 ));
/* minmax name */
...
/* bloom name */
DATA(insert (	5023	 19   19 3 s		93	  3580 0 ));
/* minmax integer */
...
/* bloom integer */
DATA(insert (	5024	 20   20 3 s	   410	  3580 0 ));
DATA(insert (	5024	 20   21 3 s	  1868	  3580 0 ));
DATA(insert (	5024	 20   23 3 s	   416	  3580 0 ));
DATA(insert (	5024	 21   21 3 s		94	  3580 0 ));
DATA(insert (	5024	 21   20 3 s	  1862	  3580 0 ));
DATA(insert (	5024	 21   23 3 s	   532	  3580 0 ));
DATA(insert (	5024	 23   23 3 s		96	  3580 0 ));
DATA(insert (	5024	 23   21 3 s	   533	  3580 0 ));
DATA(insert (	5024	 23   20 3 s		15	  3580 0 ));
...
/* bloom text */
DATA(insert (	5027	 25   25 3 s		98	  3580 0 ));
/* minmax oid */
...
/* bloom oid */
DATA(insert (	5028	 26   26 3 s	   607	  3580 0 ));
/* minmax tid */
...
DATA(insert (	5030	700  700 3 s	   620	  3580 0 ));
DATA(insert (	5030	700  701 3 s	  1120	  3580 0 ));
DATA(insert (	5030	701  700 3 s	  1130	  3580 0 ));
DATA(insert (	5030	701  701 3 s	   670	  3580 0 ));
...
/* bloom abstime */
DATA(insert (	5031	702  702 3 s	   560	  3580 0 ));
/* minmax reltime */
...
/* bloom reltime */
DATA(insert (	5032	703  703 3 s	   566	  3580 0 ));
/* minmax macaddr */
...
/* bloom macaddr */
DATA(insert (	5033	829  829 3 s	  1220	  3580 0 ));
/* minmax macaddr8 */
...
/* bloom macaddr8 */
DATA(insert (	5034	774  774 3 s	  3362	  3580 0 ));
/* minmax inet */
...
/* bloom inet */
DATA(insert (	5035	869  869 3 s	  1201	  3580 0 ));
/* minmax character */
...
/* bloom character */
DATA(insert (	5036   1042 1042 3 s	  1054	  3580 0 ));
...
DATA(insert (	5037   1083 1083 3 s	  1108	  3580 0 ));
...
DATA(insert (	5038   1114 1114 3 s	  2060	  3580 0 ));
DATA(insert (	5038   1114 1082 3 s	  2373	  3580 0 ));
DATA(insert (	5038   1114 1184 3 s	  2536	  3580 0 ));
DATA(insert (	5038   1082 1082 3 s	  1093	  3580 0 ));
DATA(insert (	5038   1082 1114 3 s	  2347	  3580 0 ));
DATA(insert (	5038   1082 1184 3 s	  2360	  3580 0 ));
DATA(insert (	5038   1184 1082 3 s	  2386	  3580 0 ));
DATA(insert (	5038   1184 1114 3 s	  2542	  3580 0 ));
DATA(insert (	5038   1184 1184 3 s	  1320	  3580 0 ));
...
/* bloom interval */
DATA(insert (	5041   1186 1186 3 s	  1330	  3580 0 ));
...
DATA(insert (	5042   1266 1266 3 s	  1550	  3580 0 ));
/* minmax bit */
...
/* bloom numeric */
DATA(insert (	5045   1700 1700 3 s	  1752	  3580 0 ));
/* minmax uuid */
...
/* bloom uuid */
DATA(insert (	5046   2950 2950 3 s	  2972	  3580 0 ));
...
/* bloom pg_lsn */
DATA(insert (	5047   3220 3220 3 s	  3222	  3580 0 ));
/* inclusion box */
