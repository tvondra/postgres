...
CATALOG(pg_changeset,3349) BKI_WITHOUT_OIDS BKI_SCHEMA_MACRO
{
	...
	Oid			chsetrelid;		/* OID of the relation it tracks */
	int16		chsetnatts;		/* number of columns in the changeset */

	/* variable-length fields start here, but we allow direct access to chsetkey */
	int2vector	chsetkey;		/* column numbers of cols */

	/* XXX might be useful to add 'chsetpred' to define filtered changesets */
