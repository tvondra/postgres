...
DESCR("greater than or equal");
DATA(insert OID = 3246 (  "@>"	   PGNSP PGUID b f f 3802 3802 16 3250 0 jsonb_contains jsonbcontsel contjoinsel ));
...
DESCR("exists all");
DATA(insert OID = 3250 (  "<@"	   PGNSP PGUID b f f 3802 3802 16 3246 0 jsonb_contained jsonbcontsel contjoinsel ));
