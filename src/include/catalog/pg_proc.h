...
DATA(insert OID = 3394 (  colgettuple		PGNSP PGUID 12 1 0 0 0 f f f f t f v s 2 0 16 "2281 2281" _null_ _null_ _null_ _null_ _null_	colgettuple _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3395 (  colgetbitmap		PGNSP PGUID 12 1 0 0 0 f f f f t f v s 2 0 20 "2281 2281" _null_ _null_ _null_ _null_ _null_	colgetbitmap _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3396 (  colinsert			PGNSP PGUID 12 1 0 0 0 f f f f t f v s 6 0 16 "2281 2281 2281 2281 2281 2281" _null_ _null_ _null_ _null_ _null_	colinsert _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3397 (  colbeginscan		PGNSP PGUID 12 1 0 0 0 f f f f t f v s 3 0 2281 "2281 2281 2281" _null_ _null_ _null_ _null_ _null_	colbeginscan _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3398 (  colrescan			PGNSP PGUID 12 1 0 0 0 f f f f t f v s 5 0 2278 "2281 2281 2281 2281 2281" _null_ _null_ _null_ _null_ _null_ colrescan _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3399 (  colendscan			PGNSP PGUID 12 1 0 0 0 f f f f t f v s 1 0 2278 "2281" _null_ _null_ _null_ _null_ _null_ colendscan _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3400 (  colmarkpos			PGNSP PGUID 12 1 0 0 0 f f f f t f v s 1 0 2278 "2281" _null_ _null_ _null_ _null_ _null_ colmarkpos _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3401 (  colrestrpos		PGNSP PGUID 12 1 0 0 0 f f f f t f v s 1 0 2278 "2281" _null_ _null_ _null_ _null_ _null_ colrestrpos _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3405 (  colbuild			PGNSP PGUID 12 1 0 0 0 f f f f t f v s 3 0 2281 "2281 2281 2281" _null_ _null_ _null_ _null_ _null_ colbuild _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3406 (  colbuildempty		PGNSP PGUID 12 1 0 0 0 f f f f t f v s 1 0 2278 "2281" _null_ _null_ _null_ _null_ _null_ colbuildempty _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3407 (  colbulkdelete		PGNSP PGUID 12 1 0 0 0 f f f f t f v s 4 0 2281 "2281 2281 2281 2281" _null_ _null_ _null_ _null_ _null_ colbulkdelete _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3408 (  colvacuumcleanup	PGNSP PGUID 12 1 0 0 0 f f f f t f v s 2 0 2281 "2281 2281" _null_ _null_ _null_ _null_ _null_ colvacuumcleanup _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3409 (  colcanreturn		PGNSP PGUID 12 1 0 0 0 f f f f t f s s 2 0 16 "2281 23" _null_ _null_ _null_ _null_ _null_ colcanreturn _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3410 (  colcostestimate 	PGNSP PGUID 12 1 0 0 0 f f f f t f v s 7 0 2278 "2281 2281 2281 2281 2281 2281 2281" _null_ _null_ _null_ _null_ _null_ colcostestimate _null_ _null_ _null_ ));
DESCR("columnar(internal)");
DATA(insert OID = 3411 (  coloptions		PGNSP PGUID 12 1 0 0 0 f f f f t f s s 2 0 17 "1009 16" _null_ _null_ _null_ _null_  _null_ coloptions _null_ _null_ _null_ ));
DESCR("columnar(internal)");
