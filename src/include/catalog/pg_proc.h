...
DATA(insert OID = 4153 ( brin_minmax_multi_distance_tid		PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "2281 2281" _null_ _null_ _null_ _null_ _null_ brin_minmax_multi_distance_tid _null_ _null_ _null_ ));
DESCR("BRIN minmax compute distance between tid values");
DATA(insert OID = 4154 ( brin_minmax_multi_distance_uuid		PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "2281 2281" _null_ _null_ _null_ _null_ _null_ brin_minmax_multi_distance_uuid _null_ _null_ _null_ ));
DESCR("BRIN minmax compute distance between uuid values");
DATA(insert OID = 4160 ( brin_minmax_multi_distance_time	PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "2281 2281" _null_ _null_ _null_ _null_ _null_ brin_minmax_multi_distance_time _null_ _null_ _null_ ));
DESCR("BRIN minmax compute distance between time values");
DATA(insert OID = 4161 ( brin_minmax_multi_distance_interval	PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "2281 2281" _null_ _null_ _null_ _null_ _null_ brin_minmax_multi_distance_interval _null_ _null_ _null_ ));
DESCR("BRIN minmax compute distance between interval values");
DATA(insert OID = 4162 ( brin_minmax_multi_distance_timetz	PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "2281 2281" _null_ _null_ _null_ _null_ _null_ brin_minmax_multi_distance_timetz _null_ _null_ _null_ ));
