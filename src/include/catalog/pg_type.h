...
/* jsonb */
DATA(insert OID = 3802 ( jsonb			PGNSP PGUID -1 f b U f t \054 0 0 3807 jsonb_in jsonb_out jsonb_recv jsonb_send - - jsonb_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
DESCR("Binary JSON");
