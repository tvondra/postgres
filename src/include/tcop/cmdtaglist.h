...
PG_CMDTAG(CMDTAG_CREATE_CHANGESET, "CREATE CHANGESET", true, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_CUBE, "CREATE CUBE", true, false, false)
...
PG_CMDTAG(CMDTAG_DROP_CHANGESET, "DROP CHANGESET", true, false, false)
...
PG_CMDTAG(CMDTAG_DROP_CUBE, "DROP CUBE", true, false, false)
