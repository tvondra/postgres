...
extern void pgstat_report_files(int64 accesses, int64 opens, int64 hits);
extern void pgstat_report_fastpath_locks(int64 acquired, int64 not_eligible, int64 not_enough);
