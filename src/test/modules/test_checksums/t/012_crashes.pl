...
sub test_checksum_transition
{
	...
	$node->safe_psql('postgres',
		"SELECT '========== " . $start . " / " . $change . " / " . $initstr . " / " . $point1 . " / " . $final . " =========='");

	note($start . " / " . $change . " / " . $initstr . " / " . $point1 . " / " . $final);
...
test_checksum_transition('disabled', 'enable', undef, 'datachecksums-enable-checksums-start', 'datachecksums-enable-checksums-after-xlog', 'off');
...
test_checksum_transition('enabled', 'disable', undef, 'datachecksums-disable-inprogress-checksums-start', 'datachecksums-disable-inprogress-checksums-after-xlog', 'on');
test_checksum_transition('enabled', 'disable', 'datachecksums-disable-inprogress-checksums-start', 'datachecksums-disable-inprogress-checksums-after-xlog', 'datachecksums-disable-inprogress-checksums-after-xlogctl', 'off');
