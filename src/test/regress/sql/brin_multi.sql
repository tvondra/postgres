CREATE TABLE brintest_multi (byteacol bytea,
	charcol "char",
	namecol name,
	int8col bigint,
	int2col smallint,
...
INSERT INTO brintest_multi (inetcol, cidrcol, int4rangecol) SELECT
...
UPDATE brintest_multi SET textcol = '' WHERE textcol IS NOT NULL;
