...
SELECT * FROM check_estimated_rows('SELECT * FROM histograms WHERE a < 5 AND b < ''5''');

SELECT * FROM check_estimated_rows('SELECT * FROM histograms WHERE a < 5 AND b < ''5'' AND c < 5');
...
SELECT * FROM check_estimated_rows('SELECT * FROM histograms WHERE a < 3 AND c < 3');

SELECT * FROM check_estimated_rows('SELECT * FROM histograms WHERE a < 3 AND b > ''2'' AND c < 3');
...
SELECT * FROM check_estimated_rows('SELECT * FROM histograms WHERE a IS NULL AND b IS NULL');

SELECT * FROM check_estimated_rows('SELECT * FROM histograms WHERE a IS NULL AND b IS NULL AND c IS NULL');
...
SELECT stxhistogram IS NOT NULL FROM pg_statistic_ext WHERE stxname = 'histograms_stats';
